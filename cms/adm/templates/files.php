...
function rename_onclick(){
	...
	for (i = 1; i < thisCheckBoxes.length; i++){
		if (thisCheckBoxes[i].name=="ids") {
			if (thisCheckBoxes[i].checked) {
				var html="<div align=\"right\"><a href=\"\" style=\"font-family: wingdings; color: silver; text-decoration: none;font-size: 20px;\" onclick=\"mb.style.display='none';return false;\"><img src=\"i/close.gif\" width=\"7\" height=\"7\"></a></div><h1 style=\"background: #EFEFE4; font-size: 140%; font-weight: normal;padding: 5px\"><?php echo __("Rename") ?></h1><form action=\"?chid=" + chid + "&action=rename&from=" + thisCheckBoxes[i].value.replace('\/', "") + "&dir="+cur_dir+"\" name=\"FP\" method=\"post\"><table cellspacing=\"0\" cellpadding=\"5\" class=\"noborder\"><tr><td><?php echo __("Old name") ?>&nbsp;&nbsp;&nbsp;</td><td valign=\"top\" width=\"100%\">" + thisCheckBoxes[i].value.replace('\/', "") + "</td><td></td></tr><tr><td><?php echo __("New name") ?>&nbsp;&nbsp;&nbsp;</td><td valign=\"top\" width=\"100%\"><input name=\"to\" maxlength=\"30\" size=\"30\" value=\"" + thisCheckBoxes[i].value.replace('\/', "") + "\"></td><td></td></tr><tr><td style=\"font-size: 80%;font-family: tahoma; color: gray;\" colspan=\"2\">Не более 30 знаков. Only Latin letters, numbers, underscores (_) and hyphen (-)</td></tr><tr><td colspan=\"2\"><input type=\"submit\" value=\"<?php echo __("Save") ?>\">&nbsp;<input type=\"button\" value=\"<?php echo __("Cancel") ?>\" onClick=\"mb.style.display='none';\"></td></tr></table></form><script>document.FP.name.focus();</script>";
				openWnd(400, html);
				break;
			}
		}
