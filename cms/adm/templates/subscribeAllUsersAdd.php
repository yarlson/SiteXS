...
<p align="center"><input type="button" value="<?php echo __("Cancel") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php echo __("Save") ?>" style="width: auto;"></p>
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
		...
		<tr>
			...
			<td><input maxlength="255" name="fields[name]" size="40" value="$data[name]" title="<?php echo __("Name") ?>"></td>
		</tr>
		<tr>
			<td><b>E-mail&nbsp;*</b></td>
...
<legend style="background-color: #F8F8F3;padding: 0.5em;border: 1px solid silver;margin-bottom: 0.5em;"><?php echo __("Mailing lists") ?></legend>
$lists
</fieldset>
$approved
<p align="center"><input type="button" value="<?php echo __("Cancel") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php echo __("Save") ?>" style="width: auto;"></p>
