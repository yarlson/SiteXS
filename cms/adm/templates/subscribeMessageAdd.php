...
<p align="center"><input type="button" value="<?php echo __("Cancel") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php echo __("Save") ?>" style="width: auto;"></p>
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
		...
		<tr>
			...
			<td><input maxlength="255" name="fields[subj]" size="40" value="$data[subj]" title="<?php echo __("Subject") ?>"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea cols="40" name="fields[html]" rows="20">$data[html]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[html]');"><?php echo __("Visual editor") ?></a></td>
		</tr>
	</table>
