...
<tr>
	<td width="100%"><h3 style="margin: 0px;"><?php echo __("Mailing list") ?> &laquo;$listName&raquo;</h3></td>
...
<input name="fields[id]" size="20" value="$data[id]" type="Hidden">
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
		...
		<tr>
			<td><b><?php echo __("Subject") ?>&nbsp;*</b></td>
			<td><input maxlength="255" name="fields[title]" size="40" value="$data[title]" title="<?php echo __("Subject") ?>"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><textarea cols="40" name="fields[description]" rows="20">$data[description]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[description]');"><?php echo __("Visual editor") ?></a></td>
		</tr>
	</table>
<p><b>*&nbsp;&mdash; <?php echo __("Required fields") ?></b></p>
<p align="center"><input type="button" value="<?php echo __("Cancel") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php echo __("Save") ?>" style="width: auto;"></p>
</form>
</td>
</tr>
</table>