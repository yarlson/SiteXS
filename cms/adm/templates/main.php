...
<body>
<div id="header">
<div><?php echo __("Current user") ?>: <strong><a href="?chid=6&action=edit&id=<?php echo $this->user_id ?>"><?php echo $ref->user ?></a></strong>&nbsp; &nbsp;<a href="?action=logout" style="font-size: 11px;"><img src="i/logout.gif" alt="" width="16" height="16" hspace="6" border="0" align="absmiddle"><?php echo __("Log out") ?></a></div>
