...
* Last Modified..: $Date: 2006-01-03 21:03:33 $
...
*/
	...
	function htmlMimeMail()
	{
        ...
        */
		...
		$this->build_params['html_charset']  = 'windows-1251';
		$this->build_params['text_charset']  = 'windows-1251';
		$this->build_params['head_charset']  = 'windows-1251';
        ...
        */
		...
		$this->smtp_params['host'] = 'mail.m-2.ru';
...
*/
	function setTextCharset($charset = 'windows-1251')
	{
...
*/
	function setHtmlCharset($charset = 'windows-1251')
	{
...
*/
	function setHeadCharset($charset = 'windows-1251')
	{
...
* content-id's.
*/
	function setHtml($html, $text = null, $images_dir = "")
	{
		$this->html      = $html;
		$this->html_text = $text;
	}
		...
		switch ($type) {
			case 'mail':
				...
				foreach ($this->headers as $name => $value) {
					$headers[] = $name . ': ' . (($name!="Content-Type") ? $this->_encodeHeader($value, $this->build_params['head_charset']) : $value);
				}
