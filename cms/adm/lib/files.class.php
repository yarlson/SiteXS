...
class files {
				...
				if ($value!=="/.") {
					...
					if (substr($value, 0,1)=="/") {
						if ($value=="/..") {
							...
							$value1="";
							$folder_tr.="<tr id=\"tr".$ii."\" class=\"default\"><td></td><td><a href=\"?chid=".$this->chid."&dir=$dir1\">$value</a></td><td>".__("Folder")."</td><td></td><td></td></tr>\n";
						}
						else {
							$dir1=$dir;
							$value1=$value;
							$folder_tr.="<tr id=\"tr".$ii."\" class=\"default\" onclick=\"return CheckTR(this);\"><td align=\"center\"><input type=\"Checkbox\" value=\"$value\" id=\"cb".$ii."\" onclick=\"return CheckCB(this);\" name=ids class=\"check\"></td><td><a href=\"?chid=".$this->chid."&dir=$this->dir$value1\">$value</a></td><td>".__("Folder")."</td><td></td><td></td></tr>\n";
						}
					}
					else {
						$files_tr.="<tr id=\"tr".$ii."\" class=\"default\" onclick=\"return CheckTR(this);\"><td align=\"center\"><input type=\"Checkbox\" id=\"cb".$ii."\" value=\"$value\" onclick=\"return CheckCB(this);\" name=ids class=\"check\"></td><td><a href=\"".$this->root.$this->dir."/$value\" target=\"_blank\">$value</a></td><td>".$this->_getType($this->global_dir."/".$value, $ext)."</td><td>".number_format($stat[7]/1000, 2, ',', ' ')." ".__("KB")."</td><td>".date("d.m.Y H:i",$stat[9])."</td></tr>\n";
					}
				}
			}
	...
	function _getType($file, $ext) {
		...
		$t=@getimagesize($file);
		return __("File")." \"".(($type[$t[2]]) ? $type[$t[2]] : strtoupper($ext))."\"";
	}
}
